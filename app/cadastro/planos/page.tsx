      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Todos os planos incluem acesso a todas as funcionalidades principais. Escolha o que melhor se adapta às
              suas necessidades.
            </p>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="mt-4 pt-4 border-t w-full text-center">
            <p className="text-sm text-gray-500 mb-2">Quer experimentar antes de assinar?</p>
            <Button
              variant="outline"
              className="text-blue-600 border-blue-600 hover:bg-blue-50"
              onClick={() => router.push("/cadastro/teste-gratuito")}
            >
              Criar conta grátis
            </Button>
          </div>
